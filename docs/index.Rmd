...
---
## Linux
* Acesse esse [link](https://cran.r-project.org//), selecione Linux e você será direcionado para uma página com a figura abaixo. 

```{r echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("img/linux.jpeg")
```

* Escolha a sua distribuição de Linux e siga as instruções para instalação
